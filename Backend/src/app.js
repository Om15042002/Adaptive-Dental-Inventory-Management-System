    ...
    formatResponse(
      {
        ...
        version: "1.0.0",
        description:
          "Intelligent inventory management system for dental practices",
        endpoints: {
          auth: "/api/auth",
        ...
        documentation:
          "https://github.com/your-repo/adaptive-dental-inventory-api",
      },
      "API Information"
    )
  );
...
app.use("*", (req, res) => {
  res
    .status(404)
    .json(formatResponse(null, `Route ${req.originalUrl} not found`, 404));
});
...
app.use((error, req, res, next) => {
  ...
  if (error.type === "entity.parse.failed") {
    return res
      .status(400)
      .json(formatResponse(null, "Invalid JSON payload", 400));
  }
